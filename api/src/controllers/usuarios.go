...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível autalizar a senha de um usuário que não seja o seu"))
		return
	}
	...
	if senha.Nova != senha.Confirmar {
		respostas.Erro(w, http.StatusBadRequest, errors.New("a senha nova e a confirmação precisam ser iguais"))
		return
	}
